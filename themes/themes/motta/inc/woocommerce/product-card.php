...
class Product_Card {
	...
	public function product_add_to_cart_link( $html, $product, $args ) {
		echo sprintf(
			'<a href="%s" aria-describedby="woocommerce_loop_add_to_cart_link_describedby_%s" data-quantity="%s" class="%s product-add-to-cart_link" %s>%s <span class="button_text">%s</span></a>',
