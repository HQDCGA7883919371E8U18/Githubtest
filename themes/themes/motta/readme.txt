...
- Fix: Can't change columns 5 in the shop page
- Fix: Product first tab can't open on mobile
- Fixed: Some bugs related CSS

Version 1.3.7

- Updated: The templates of WooCommerce 9.3.1

Version 1.3.6

- New: Add new option to show a product video option in the WCFM Store Manager(Appearance > Customizer > Store manager > Custom Fields)
- Updated: The templates of WooCommerce 9.2.3
- Fixed: Search by product SKU

Version 1.3.5

- New: Add loading icon to the checkout processing
...
- New: Add custom badge to the single product
- New: Add custom menu to  the header hamburger and header mobile
- New: Add new option to enable default catalog view
- Fixed: SKU is not updated when change a variation
...
- Fixed: Kirki can't load the google font(https://prnt.sc/z2frT4ItpwwZ)
